		...
		for (String effectName : effectList){
			...
			buttonLoop.addListener(new ClickListener(){
				...
				public void clicked(InputEvent event, float x, float y){
					...
					try{
						procText = (ProceduralInterface) ClassReflection.newInstance(ClassReflection.forName(checked.getName()));
						...
						Log.error(this.getClass().getName(), "Error create effect ...", ex);
					}
				}
			});
