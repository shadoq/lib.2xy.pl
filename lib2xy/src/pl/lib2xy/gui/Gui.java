...
public class Gui{
	...
	public Cell addRow(final Actor firstElement, final Actor secondElement, final String label, final int height, final int colSpan, final boolean newRow,
		...
		if (label != null){
			...
			if (newRow){
				table.row();
				table.add(guiLabel).left().expandX().fillX().colspan(colSpan + 1);
				table.row();
			} else {
				table.add(guiLabel).left().expandX().fillX().colspan(colSpan + 1);
			}
	...
	public ColorSampler addColorBrowserChange(String label, Object object, String fieldName, Color value, boolean newRow, int colSpan,
		...
		final ColorSampler colorBrowser = new ColorSampler();
		colorBrowser.setColor(value);
		colorBrowser.addListener(new ChangeListener(){
	...
	//		return addFileBrowser(label, object, fieldName, value, true, 2, false, changeListener, Cfg.listSizeY
	//		+ Cfg.buttonImage);
	//	}
	//
	...
	//		return addFileBrowser(label, object, fieldName, "", true, colSpan, false, changeListener, Cfg.listSizeY
	//		+ Cfg.buttonImage);
	//	}
	//
	//	/**
	...
	//				if (Cfg.DEBUG){
	//					Log.log("effectTextureFadeWindow::fileTableFrom::click", "selectFile=" + text);
	//				}
	...
	//
	//		FileBrowser fileBrowser = new FileBrowser();
	//		final Table fileTable = fileBrowser.getTable(value, Cfg.defaultDir, "fileBrowser");
	//
	//		fileBrowser.setListener(new WidgetStringListener(){
	//			@Override
	//			public void Action(String text){
