...
import pl.lib2xy.items.TextFieldVO;

/**
 * Created by Jarek on 2014-06-06.
 */
public class TextField extends com.badlogic.gdx.scenes.scene2d.ui.TextField implements GuiInterface, DataVO{

	protected Skin skin;
	public TextFieldVO data = new TextFieldVO();
	...
	public TextField(TextFieldVO textFieldVO, Skin skin){
		super(textFieldVO.text, skin);
		this.skin = skin;
		setVO(textFieldVO);
	}
	...
	public void setVO(TextFieldVO textFieldVO){
		data = textFieldVO;
