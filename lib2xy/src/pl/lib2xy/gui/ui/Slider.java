...
import pl.lib2xy.items.SliderVO;

/**
 * Created by Jarek on 2014-06-06.
 */
public class Slider extends com.badlogic.gdx.scenes.scene2d.ui.Slider implements GuiInterface, DataVO{

	public SliderVO data = new SliderVO();
	protected Skin skin;
	...
	public Slider(SliderVO sliderVO, Skin skin){
		super(sliderVO.min, sliderVO.max, sliderVO.step, sliderVO.vertical, skin);
		this.skin = skin;
		data = sliderVO;
		setVO(sliderVO);
	}
	...
	public void setVO(SliderVO sliderVO){
		data = sliderVO;
