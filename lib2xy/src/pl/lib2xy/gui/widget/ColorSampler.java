...
public class ColorSampler extends Table{
	...
	private void initalize(){
		...
		add(labelTextR).left().width(Cfg.gridX1);
		add(sliderR).left().fillX().expandX();
		add(labelR).left().width(Cfg.gridX1);
		row();
		add(labelTextG).left().width(Cfg.gridX1);
		add(sliderG).left().fillX().expandX();
		add(labelG).left().width(Cfg.gridX1);
		row();
		add(labelTextB).left().width(Cfg.gridX1);
		add(sliderB).left().fillX().expandX();
		add(labelB).left().width(Cfg.gridX1);

		if (alphaChanel){
			row();
			add(labelTextA).left().width(Cfg.gridX1);
			add(sliderA).left().fillX().expandX();
			add(labelA).left().width(Cfg.gridX1);
		}
