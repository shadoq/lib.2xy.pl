...
public class ObjectMesh{
	...
	private void initMesh(){
		...
		Log.log("S3Mesh:initMesh", "AllDataOffset: " + allDataOffset, 1);
		vertexBuffer.clear();
		vertexIndex = 0;
		indicesBuffer.clear();
		indicesIndex = 0;
