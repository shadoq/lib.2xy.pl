...
public class Object2D implements ProceduralInterface{
	 ...
	 * @param blue
	 */
	public static void generate(final Pixmap pixmap, int mode, int count, int size, int growth, int randomColor, int red, int green, int blue){
		...
		for (int i = 0; i < count; i++){
			...
			if (objectsExpand[i] < growth){
				...
				pixmap.setColor((r << 24) | (g << 16) | (b << 8) | 255);
