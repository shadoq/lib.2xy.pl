...
public class Mesh{
	...
	private void initMesh(){
		...
		Log.log(TAG + "::initMesh", "Buffer size: " + (vertices * allDataOffset) + " vertices: " + vertices
		...
		// Create shader
		//
		Log.debug(TAG + "::initMesh", "Create default shader ...", 2);
		...
		Log.log(TAG + "::initMesh", "dataOffset=" + allDataOffset + " vertices=" + vertices + " vetextBufferSize="
		+ vertexBuffer.length, 1);
		Log.log(TAG + "::initMesh", "projectionMatrix=" + projectionMatrix + " transformMatrix=" + modelViewMatrix, 2);
	}

	public void setShader(String shaderName){
		shader = ResourceManager.getShaderProgram(shaderName);
		Log.log(TAG + "::initMesh", "Shader compile: " + shader.getLog());
	}
