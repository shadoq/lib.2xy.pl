...
import pl.lib2xy.utils.ShortArray;
...
public class ObjectMesh{
	...
	private final static String TAG = "ObjectMesh";
	...
	private void initMesh(){
		...
		Log.log(TAG + "::initMesh", "AllDataOffset: " + allDataOffset, 1);
		vertexBuffer.clear();
		vertexIndex = 0;
		indicesBuffer.clear();
		indicesIndex = 0;
