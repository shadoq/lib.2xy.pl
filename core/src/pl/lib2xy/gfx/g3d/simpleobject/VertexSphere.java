...
public class VertexSphere extends Object3d{
	 ...
	 * @return
	 */
	public static Mesh sphere(float radiusX, float radiusY, float radiusZ){
	 ...
	 * @return
	 */
	public static Mesh sphere(float radiusX, float radiusY, float radiusZ, float segmentsWidth, float segmentsHeight){
		...
		Log.log("Model3DPrimitive::sphere",
