...
final public class XY{
	...
	public static final ArrayMap<String, Scene> sceneMaps = new ArrayMap<>(10);
	public static final ArrayMap<String, String> sceneGuiMaps = new ArrayMap<>(10);
	public static final ArrayMap<String, String> sceneDataMaps = new ArrayMap<>(10);
