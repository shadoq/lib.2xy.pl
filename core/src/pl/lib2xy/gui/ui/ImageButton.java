...
public class ImageButton extends com.badlogic.gdx.scenes.scene2d.ui.ImageButton implements GuiInterface, DataVO{
	...
	public ImageButton(String imageFile, Skin skin){
		this(imageFile, skin, "default");
	}

	public ImageButton(String imageFile, Skin skin, String styleName){
		super(skin, styleName);
		final Texture texture = ResourceManager.getTexture(imageFile);
