...
public class Gui{
	...
	class GuiElement{
		...
		public GuiElement(String name, int type, Object object, String fieldName, Object value){
			...
			this.type = type;
			element = new Element(object, fieldName);
		}
	...
	public Cell addRow(final Actor firstElement, final Actor secondElement, final String label, final int height, final int colSpan, final boolean newRow,
		...
		if (label != null){
			...
			if (newRow){
				table.row();
				table.add(guiLabel).left().expandX().fillX().colspan(colSpan + 1).padLeft(10).padBottom(0);
				table.row();
			} else {
				table.add(guiLabel).left().expandX().fillX().colspan(colSpan + 1).padLeft(10).padBottom(0);
			}
		...
		if (height > 0){
			table.add(firstElement).left().fillX().height(height).colspan(colSpan).padBottom(0f).padLeft(10).padTop(0);
		} else {
			table.add(firstElement).left().fillX().colspan(colSpan).padTop(0f).padLeft(10).padTop(0);
		}
		if (secondElement != null){
			table.add(secondElement).left().width(40).padTop(0f).padLeft(4).padTop(0);
		} else {
			if (spaceBox){
	...
	public Button addButtonToggle(String label, Object object, String fieldName, Object value, boolean newRow, int colSpan, String groupName,
								  ChangeListener changeListener){
		return addButton(label, object, fieldName, value, newRow, colSpan, true, groupName, changeListener);
	}
		...
		if (object != null && fieldName != null){
			...
			button.addListener(new ChangeListener(){
				...
				public void changed(ChangeEvent event, Actor actor){
					Log.debug("S3Gui::button", "Change on button: " + button.getText() + " event: " + event.toString());
					element.assignValue();
					Log.debug("S3Gui::button", "New value element: " + element.getValueAsString());
		...
		if (object != null && fieldName != null){
			...
			button.addListener(new ChangeListener(){
				public void changed(ChangeEvent event, Actor actor){
					...
					Log.debug("S3Gui::button", "Change on button: " + fileName + " event: " + event.toString());
					element.assignValue();
					Log.debug("S3Gui::button", "New value element: " + element.getValueAsString());
	...
	public CheckBox addCheckBox(String label, Object object, String fieldName, final Object valueOn, final Object valueOff, boolean newRow, int colSpan,
		...
		if (object != null && fieldName != null){
			...
			checkBox.addListener(new ChangeListener(){
				@Override
				public void changed(ChangeEvent event, Actor actor){
					Log.debug("S3Gui::checkBox", "Click on checkBox: " + checkBox.getText() + " event: "
					+ event.toString());
					...
					Log.debug("S3Gui::checkBox", "New value element: " + element.getValueAsString());
					if (outListener != null && disableListener == false){
						outListener.changed(event, actor);
					}
				}
	...
	public Slider addSlider(final String label, final Object object, final String fieldName, final float value, final float min, final float max,
		...
		Log.debug("3SGui::addSlider", "label: " + label + " fieldName: " + fieldName + " value:" + value + " min: "
		...
		final String text = "" + (float) (Math.round(value * 10.0) / 10.0);
		...
		slider.addListener(new ChangeListener(){
			@Override
			public void changed(ChangeEvent event, Actor actor){
				Log.debug("S3Gui::button", "Click on button: " + slider.getValue() + " event: " + event.toString());
				element.setValue(slider.getValue());
				valueLabel.setText("" + (float) (Math.round(slider.getValue() * 10.0) / 10.0));
				Log.debug("S3Gui::button", "New value element: " + element.getValueAsString());
				if (outListener != null && disableListener == false){
					outListener.changed(event, actor);
				}
		...
		try{
			...
			Log.error("S3Gui:addSlider", "Error set value", e);
		}
	...
	public TextField addTextNumericField(String label, Object object, String fieldName, String value, String messageText, boolean newRow, int colSpan,
		...
		Log.debug("3SGui::addTextField", "label: " + label + " fieldName: " + fieldName + " value:" + value);
		//
		// Gui Element
		//
		...
		bboX.row();
		bboX.add(guiLabel).left();
		bboX.add(btnMinus).left();
		bboX.add(textField).left();
		bboX.add(btnPlus).left();
		bboX.add(btnOk).left();
		...
		textField.setTextFieldListener(new TextField.TextFieldListener(){
			...
			public void keyTyped(TextField textField, char key){
				...
				if (!Character.isDigit(key) && !TextUtil.isISOControl(key) && key != '.'){
					if (text.length() > 1){
		...
		btnOk.addListener(new ChangeListener(){
			@Override
			public void changed(ChangeEvent event, Actor actor){
				Log.debug("S3Gui::addTextNumericField", "Click on button Ok: " + textField.getText() + " event: "
				+ event.toString());
	...
	public TextField addTextField(String label, Object object, String fieldName, String value, String messageText, boolean newRow, int colSpan,
		...
		btnOk.addListener(new ChangeListener(){
			...
			public void changed(ChangeEvent event, Actor actor){
				...
				+ event.toString());
				element.setValue(textField.getText());
				Log.log("S3Gui::button", "New value element: " + element.getValueAsString());
				if (outListener != null && disableListener == false){
					outListener.changed(event, actor);
				}
			}
	...
	public List addList(String label, Object object, String fieldName, String[] listItem, String value, boolean newRow, int colSpan,
						ChangeListener changeListener){
		return addList(label, object, fieldName, listItem, value, newRow, colSpan, changeListener, 0);
	}
	...
	public List addList(String label, Object object, String fieldName, String[] listItem, String value, boolean newRow, int colSpan,
		...
		list.addListener(new ChangeListener(){
			...
			public void changed(ChangeEvent event, Actor actor){
				...
				Log.debug("S3Gui::addList", "Click on List: " + list.getSelection().first() + " event: "
				+ event.toString());
				element.setValue(list.getSelection().first());
				Log.debug("S3Gui::addList", "New value element: " + element.getValueAsString());
				if (outListener != null && disableListener == false){
					outListener.changed(event, actor);
				}
			}
		...
		addRow(scrollList, null, label, 0, colSpan, newRow, true);
		return list;
	}
	...
	public List addListIndex(String label, Object object, String fieldName, String[] listItem, int value, boolean newRow, int colSpan,
							 ChangeListener changeListener){
		return addListIndex(label, object, fieldName, listItem, value, newRow, colSpan, changeListener, 0);
	}
	...
	public List addListIndex(String label, Object object, String fieldName, String[] listItem, int value, boolean newRow, int colSpan,
		...
		list.addListener(new ChangeListener(){
			@Override
			public void changed(ChangeEvent event, Actor actor){
				Log.debug("S3Gui::button", "Click on button: " + list.getSelectedIndex() + " event: " + event.toString());
		...
		if (height == 0){
			addRow(scrollList, null, label, Cfg.gridY6, colSpan, newRow, true);
		} else {
			addRow(scrollList, null, label, height, colSpan, newRow, true);
		}
		return list;
	}
	...
	public SelectBox addSelectBox(String label, Object object, String fieldName, String[] listItem, String value, boolean newRow, int colSpan,
		...
		selectBox.addListener(new ChangeListener(){
			@Override
			public void changed(ChangeEvent event, Actor actor){
				Log.debug("S3Gui::SelectBox", "Click on SelectBox: " + selectBox.getSelection().first() + " event: " + event.toString());
				element.setValue(selectBox.getSelection().first());
				Log.debug("S3Gui::SelectBox", "New value SelectBox: " + element.getValueAsString());
	...
	public SelectBox addSelectIndexBox(final String label, final Object object, final String fieldName, final String[] listItem, final int value,
		...
		selectBox.addListener(new ChangeListener(){
			...
			public void changed(ChangeEvent event, Actor actor){
				...
				Log.debug("S3Gui::button", "Click on button: " + selectBox.getSelectedIndex() + " event: " + event.toString());
	...
	public List addColorList(String label, Object object, String fieldName, int value, boolean newRow, int colSpan, ChangeListener changeListener){
		return addListIndex(label, object, fieldName, colorsName, value, newRow, colSpan, changeListener);
	}

	public ColorSampler addColorBrowser(String label, Object object, String fieldName, Color value){
		return addColorBrowser(label, object, fieldName, value, true, 1, null);
	}

	public ColorSampler addColorBrowser(String label, Object object, String fieldName, Color value, boolean newRow){
		return addColorBrowser(label, object, fieldName, value, newRow, 1, null);
	}

	public ColorSampler addColorBrowser(String label, Object object, String fieldName, Color value, WidgetColorListener changeListener){
	 ...
	 * @return
	 */
	public ColorSampler addColorBrowser(String label, Object object, String fieldName, Color value, boolean newRow, int colSpan,
		...
		final ColorSampler colorBrowser = new ColorSampler(XY.skin);
		colorBrowser.setColor(value);
		colorBrowser.addListener(new ChangeListener(){

			@Override
			public void changed(ChangeEvent event, Actor actor){
				final Color color = colorBrowser.getColor();
				Log.debug("S3Gui::addColorBrowser::Action", "Set color: " + color.toString());
		...
		addRow(colorBrowser, null, label, 0, colSpan, newRow, true);
		return colorBrowser;
	}
	 ...
	 * @return
	 */
	public ColorSampler addColorBrowserChange(String label, Object object, String fieldName, Color value, boolean newRow, int colSpan,
											  ChangeListener changeListener){
		...
		colorBrowser.addListener(new ChangeListener(){
			...
			public void changed(ChangeEvent event, Actor actor){
				...
				element.setValue(color);
				if (outListener != null && disableListener == false){
					outListener.changed(new ChangeEvent(), colorBrowser);
				}
	 ...
	 * @return
	 */
	public FileBrowser addFileBrowserChange(String label, Object object, String fieldName, String file, String directory, boolean newRow, int colSpan,
											ChangeListener changeListener){
		...
		final Table fileTable = fileBrowser.getTable(file, directory, null);

		fileBrowser.setListener(new ChangeListener(){
			@Override
			public void changed(ChangeEvent event, Actor actor){
				if (actor instanceof FileBrowser){
					if (outListener != null && disableListener == false){
						outListener.changed(new ChangeEvent(), actor);
					}
				}
	 ...
	 * @return
	 */
	public ImageList addImageList(String label, Object object, String fieldName, String[] listItem, String directory, boolean newRow, int colSpan,
								  ChangeListener changeListener){
		...
		ChangeListener localListener = new ChangeListener(){
			...
			public void changed(ChangeEvent event, Actor actor){
				...
				Log.log("S3Gui::addImageList::changed()", "Change value: " + event + " event: " + actor);
		...
		imageList.show(listItem, directory, localListener);
	...
	public Table addEditor2d(String label, Object object, String fieldNameX, String fieldNameY, String fieldNameWidth, String fieldNameHeight,
		...
		guiBtn.addListener(new ChangeListener(){
			public void changed(ChangeEvent event, Actor actor){
				Log.log("S3Gui::button", "Click on Edit2d button ... event: " + event.toString());
				...
				ChangeListener saveEditor = new ChangeListener(){
					...
					public void changed(ChangeEvent event, Actor actor){
						...
						Log.log("S3Gui::button", "Save on Edit2d button ... event: " + event.toString() + " actor: "
						+ actor.toString());
