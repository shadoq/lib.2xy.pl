...
import pl.lib2xy.gui.ui.Button;
import pl.lib2xy.gui.ui.CheckBox;
import pl.lib2xy.gui.ui.Image;
import pl.lib2xy.gui.ui.Label;
import pl.lib2xy.gui.ui.SelectBox;
import pl.lib2xy.gui.ui.Slider;
import pl.lib2xy.gui.ui.Table;
import pl.lib2xy.gui.ui.TextButton;
import pl.lib2xy.gui.ui.TextField;
...
public class GuiResource{
	...
	public static TextField textField(String text, String messageText, String name){
		...
		TextField textfield = new TextField(text, XY.skin);
	...
	public static CheckBox checkBox(String text, String name){
		...
		CheckBox checkBox = new CheckBox(text, XY.skin);
	...
	public static Label label(String text, String name){
		...
		Label label = new Label(text, XY.skin);
		label.setName(name);
		return label;
	}
	...
	public static SelectBox selectBox(String[] item, String name){
		...
		SelectBox selectbox = new SelectBox(XY.skin);
